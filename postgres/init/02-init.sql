...
INSERT INTO "Comments" ("user_id", "product_id", "text", "rating", "created_at") VALUES
(1, 1, 'Отличный телефон за свои деньги! Камера на высоте.', 5, '2023-03-12 10:00:00'),
(2, 1, 'Батарея держит не так долго, как хотелось бы', 3, '2023-03-15 14:30:00'),
(3, 7, 'Делает вкусный кофе, но шумноватая', 4, '2023-04-20 09:15:00'),
(4, 3, 'Очень удобные часы, точные показатели здоровья', 5, '2023-05-05 16:45:00'),
(5, 4, 'Классические джинсы, сидят идеально', 5, '2023-05-25 12:20:00'),
(1, 2, 'Звук отличный, но наушники немного давят', 4, '2023-04-01 11:10:00');